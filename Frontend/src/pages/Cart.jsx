...
const Cart = () => {
  ...
  const deleteItem = async (bookid) => {
    ...
    const response = await axios.put(`http://localhost:3000/api/v1/remove-from-cart/${bookid}`,
      {},
      {headers}
    );
 ...
 const PlaceOrder = async () => {
  ...
  return (
    <div className='bg-zinc-900 px-12 h-screen py-8'>
      {loading && <div className='w-full h-[100%] flex items-center justify-center'><Loader /></div>}
